...
<body>
	<div id="board">
        ...
        <div class="container">
        	<form method="POST" action="/board/post" onsubmit="return false;">
	            <div id="bbs-row" class="row justify-content-center align-items-center">
	                <div id="bbs-column" class="col-md-6">
	                    <div id="bbs-box" class="col-md-12">
	                    	<h3 class="text-center text-info">게시글 작성</h3>
	                    	<table class="table">
	                    		<colgroup>
		                            <col width="30%">
		                            <col width="70%">
		                        ...
		                        <tbody>
							        ...
							        <tr>
							            <th>작성자</th>
							            <td><input type="text" name="writer" class="form-control" value="${userInfo.username}"></td>
							        </tr>
							        <tr>
							            <th>내용</th>
